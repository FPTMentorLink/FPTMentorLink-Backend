...
public class VnPayService : IVnPayService
{
    ...
    public VnPayService(VnPayLibrary vnpay, IConfiguration configuration, IServiceProvider serviceProvider)
    {
        _vnpay = vnpay;
    ...
    public async Task<string?> CreatePaymentLink(CreateVnPayPaymentModel model)
    {
        try
        {
